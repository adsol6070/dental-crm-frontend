...
const ROUTES = {
  ...
  DOCTOR: {
    ...
    APPOINTMENTS_TODAY: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.DOCTOR_APPOINTMENTS_TODAY),
    APPOINTMENTS_UPCOMING: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.DOCTOR_APPOINTMENTS_UPCOMING),
    APPOINTMENT_DETAILS: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.DOCTOR_APPOINTMENT_DETAILS),
    SCHEDULE: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.DOCTOR_SCHEDULE),
    UNAVAILABLE_DAYS: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.DOCTOR_UNAVAILABLE_DAYS),
    PRESCRIPTIONS: getFullPath(
      PREFIXES.DOCTOR,
    ...
    NOTIFICATIONS: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.DOCTOR_NOTIFICATIONS),
    PROFILE: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.DOCTOR_PROFILE),
    SETTINGS: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.SETTINGS),
    CHANGE_PASSWORD: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.DOCTOR_CHANGE_PASSWORD),
    ACCOUNT_MANAGEMENT: getFullPath(PREFIXES.DOCTOR, ROUTE_PATHS.DOCTOR_ACCOUNT_MANAGEMENT),
  },
  // Admin routes
  ADMIN: {
